...
*У Лекції 3 ER-діаграма існувала лише на папері (чи в mermaid-схемі) —
...
пересозданні таблиці, кожен старий `INSERT` без переліку колонок або
...
зв'язок "один до багатьох" з ER-діаграми Лекції 3, тільки записаний
...
"один власник → багато тварин", який на ER-діаграмі Лекції 3
позначався лінією `||--o{`.
...
вище. Схема, яку в Лекції 3 було лише намальовано, тут стала робочою
