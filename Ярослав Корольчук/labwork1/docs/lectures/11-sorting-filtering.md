...
`WHERE` (Лекція 2), воно вільно посилається на псевдонім із `SELECT`:
...
**Практика до цієї лекції:** [Практика 10. Сортування і фільтрація](../practice/10-sorting-filtering.md)
