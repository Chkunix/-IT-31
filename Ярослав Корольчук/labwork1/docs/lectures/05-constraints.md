...
*Лекція 4 закріпила один тип цілісності — зв'язки між таблицями через
...
`NOT NULL` вже з'являвся побіжно в прикладах Лекцій 1 і 4 — тепер
...
рядкам, бо, за логікою трьохзначної логіки з Лекції 2, `NULL` ніколи не
...
`INSERT` не передав колонку явно. Приклад уже траплявся в Лекції 4:
...
**Чим це відрізняється від типу колонки.** Type affinity з Лекції 1
