...
Сім позицій цього модуля супроводжують Лекції 0–6 і закладають те, без
...
рендериться автоматично, як у прикладах [Лекції 3](../lectures/03-er-modeling.md)
...
- Перевірте кожен зв'язок питанням з обох боків: "скільки Б відповідає
  ...
  1:1, 1:N чи M:N (детальніше — [Лекція 3](../lectures/03-er-modeling.md)).
...
- Зв'язок M:N ніколи не реалізується двома зовнішніми ключами в одній
  ...
  [Лекція 3](../lectures/03-er-modeling.md), розділ про M:N).
